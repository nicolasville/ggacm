...
Pour `extraire_individu()` il faut préciser le nom d'une de vos variables qui permettent d'identifier chaque individus. Dans mon cas par exemple, ma base de donnée recense des chaînes YouTube et Twitch, chaque individu a un `titre` de chaîne unique. Ce sera donc `titre` :
