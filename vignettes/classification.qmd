...
Pour créer la classification, utilisez la fonction `FactoMineR:HCPC()` sur les résultats de votre ACM. Le paramètre `nb.clust` détermine le nombre de classe que vous souhaitez garder. Dans cette exemple, je vais en garder 3. Si vous souhaitez que R choisisse automatiquement le nombre de classe, indiquez -1.
